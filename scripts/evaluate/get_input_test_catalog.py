...
if __name__ == '__main__':
    ...
    sim_catalogs_dirs    = ["/data/simulation_data/catalogs"]                                 # List of directories containing simulated catalogs in FITS format that will be scanned for FITS catalogs and processed yielding great flexibility.
    ...
    catalog_file_name    = "noisy_input_test_catalog.csv"
    ...
    max_workers          = 10                                                                 # Number of processes to use. Each process requires at least the equivalent of individual catalogs in memory.
