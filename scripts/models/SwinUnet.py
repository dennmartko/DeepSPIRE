'''
This module implements Swin-UNET architecture in TensorFlow. We made use of an existing Keras Vision Trans-
former implementation available at https://github.com/yingkaisha/keras-vision-transformer/tree/main.

Most of the code here is adapted from this repository with minor modifications to suit our needs.
'''
...
class WindowAttention(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        ...
        # convert to tf constant (NOT tf.Variable for TF-2.16+)
